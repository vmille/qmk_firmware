...
* `-----------------------------------------------------------------------------------'
   ...
   [_BASE_CTL] = LAYOUT(
       ...
       SC_LSPO , KC_A  , LALT_T(KC_S), LSFT_T(KC_D) , LCTL_T(KC_F)       , LCTL_T(KC_G), RCTL_T(KC_H), RCTL_T(KC_J)     , RSFT_T(KC_K), LALT_T(KC_L), KC_SCLN        , SC_RSPC ,
       KC_LBRC , KC_Z  , KC_X        , KC_C         , KC_V               , KC_B        , KC_N        , KC_M             , KC_COMM     , KC_DOT      , KC_SLSH        , KC_RBRC ,
       KC_DEL  , KC_ESC, LALT(KC_SPC), RALT(KC_COMM),_______, MO(_NAVIGATION_CTL), KC_ENTER    , KC_SPC      , MO(_FUNCTION_CTL),_______, KC_GRAVE    , KC_LGUI     , X(POINT_MEDIAN), KC_BSPC
       ),
...
* `-----------------------------------------------------------------------------------'
   ...
   [_NAVIGATION_CTL] = LAYOUT(
       ...
       _______, _______, _______        , _______        ,_______, _______        , _______        , KC_TAB , _______, _______,_______, _______ , _______      , _______
       ),
   /* BASE
* ,-----------------------------------------------------------------------------------.
* |  =   |   1  |   2  |   3  |   4  |   5  |   6  |   7  |   8  |   9  |   0  |  -   |
...
* `-----------------------------------------------------------------------------------'
   ...
   [_BASE_CMD] = LAYOUT(
       KC_EQUAL, KC_1  , KC_2        , KC_3         , KC_4               , KC_5        , KC_6        , KC_7             , KC_8        , KC_9        , KC_0           , KC_MINUS,
       KC_BSLS , KC_Q  , KC_W        , KC_E         , KC_R               , KC_T        , KC_Y        , KC_U             , KC_I        , KC_O        , KC_P           , KC_QUOTE,
       SC_LSPO , KC_A  , LALT_T(KC_S), LSFT_T(KC_D) , LCMD_T(KC_F)       , LCTL_T(KC_G), RCTL_T(KC_H), RCMD_T(KC_J)     , RSFT_T(KC_K), LALT_T(KC_L), KC_SCLN        , SC_RSPC ,
       KC_LBRC , KC_Z  , KC_X        , KC_C         , KC_V               , KC_B        , KC_N        , KC_M             , KC_COMM     , KC_DOT      , KC_SLSH        , KC_RBRC ,
       KC_DEL  , KC_ESC, LALT(KC_SPC), RALT(KC_COMM),_______, MO(_NAVIGATION_CMD), KC_ENTER    , KC_SPC      , MO(_FUNCTION_CMD),_______, KC_GRAVE    , LCMD(KC_SPC), X(POINT_MEDIAN), KC_BSPC
       ),
